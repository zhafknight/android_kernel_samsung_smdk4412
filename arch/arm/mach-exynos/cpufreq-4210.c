...
static const unsigned int asv_voltage_A[CPUFREQ_LEVEL_END][8] = {
	...
	{ 1475000, 1450000, 1450000, 1425000, 1400000, 1375000, 1350000, 1325000 }, /*1600MHz*/
	{ 1450000, 1400000, 1400000, 1375000, 1350000, 1325000, 1300000, 1275000 }, /*1500MHz*/
...
int exynos4210_cpufreq_init(struct exynos_dvfs_info *info)
{
	...
	info->pm_lock_idx = L8; /* PM safe freq should be 800Mhz on cpu wakeup */
	info->pll_safe_idx = L6; /* Safe freq should be 1000Mhz */
