...
static struct sleep_save exynos4_l2cc_save[] = {
	SAVE_ITEM(S5P_VA_L2CC + L310_TAG_LATENCY_CTRL),
	SAVE_ITEM(S5P_VA_L2CC + L310_DATA_LATENCY_CTRL),
	SAVE_ITEM(S5P_VA_L2CC + L310_PREFETCH_CTRL),
	SAVE_ITEM(S5P_VA_L2CC + L310_POWER_CTRL),
